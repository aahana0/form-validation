...
function checkemail(email){
    if(email.length>8 && email.includes('@gmail')){
        ...
        document.getElementById('email_error').innerText='email must include @gmail and be 8 letters long'
    }
...
function checkpasswordmatch(password, cpassword){
    if(password==cpassword && password!=''){
        ...
        document.getElementById('cpassword_error').innerText='password dont match'
    }
